...
class FixInvalidJsonInDb {
    ...
    public function ensureValidJsonString($val) {
        ...
        try {
            $decoded = \DevOwl\RealCookieBanner\Vendor\ColinODell\Json5\Json5Decoder::decode($val, \true);
            $newVal = \json_encode($decoded);
            return $val !== $newVal ? $newVal : \false;
        } catch (\DevOwl\RealCookieBanner\Vendor\ColinODell\Json5\SyntaxError $e) {
            return \false;
        }
    }
    /**
