 ...
 * Service template.
 */
class ServiceTemplate extends \DevOwl\RealCookieBanner\Vendor\DevOwl\ServiceCloudConsumer\templates\AbstractTemplate {
    /**
    ...
    /**
     * Is the service processing data in countries with unsafe privacy rules? 2-letter ISO codes.
     *
     * @var string[]
     */
    public $dataProcessingInUnsafeCountries = [];
    /**
    ...
    public function fromArray($arr) {
        ...
        if (\is_array($arr)) {
            ...
            $this->providerLegalNoticeUrl = \is_string($arr['providerLegalNoticeUrl'] ?? null)
                ? $arr['providerLegalNoticeUrl']
                : '';
            $this->providerPrivacyPolicyUrl = \is_string($arr['providerPrivacyPolicyUrl'] ?? null)
                ? $arr['providerPrivacyPolicyUrl']
                : '';
            $this->technicalDefinitions = \is_array($arr['technicalDefinitions'] ?? null)
            ...
            $this->shouldUncheckContentBlockerCheckboxWhenOneOf = \is_array(
                $arr['shouldUncheckContentBlockerCheckboxWhenOneOf'] ?? null
            )
                ? $arr['shouldUncheckContentBlockerCheckboxWhenOneOf']
                : [];
            $this->shouldRemoveTechnicalHandlingWhenOneOf = \is_array(
                $arr['shouldRemoveTechnicalHandlingWhenOneOf'] ?? null
            )
                ? $arr['shouldRemoveTechnicalHandlingWhenOneOf']
                : [];
            ...
            $this->tagManagerOptInEventName = \is_string($arr['tagManagerOptInEventName'] ?? null)
                ? $arr['tagManagerOptInEventName']
                : '';
            $this->tagManagerOptOutEventName = \is_string($arr['tagManagerOptOutEventName'] ?? null)
                ? $arr['tagManagerOptOutEventName']
                : '';
            $this->executeCodeOptInWhenNoTagManagerConsentIsGiven = \boolval(
                $arr['shouldUncheckContentBlockerCheckbox'] ?? null
            );
            $this->executeCodeOptOutWhenNoTagManagerConsentIsGiven = \boolval(
                $arr['shouldUncheckContentBlockerCheckbox'] ?? null
            );
            $this->deleteTechnicalDefinitionsAfterOptOut = \boolval(
                $arr['deleteTechnicalDefinitionsAfterOptOut'] ?? null
            );
            ...
            $this->technicalHandlingNotice = \is_string($arr['technicalHandlingNotice'] ?? null)
                ? $arr['technicalHandlingNotice']
                : '';
            $this->createContentBlockerNotice = \is_string($arr['createContentBlockerNotice'] ?? null)
                ? $arr['createContentBlockerNotice']
                : '';
