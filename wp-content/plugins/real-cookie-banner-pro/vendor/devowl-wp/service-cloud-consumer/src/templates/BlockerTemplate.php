 ...
 * Blocker template.
 */
class BlockerTemplate extends \DevOwl\RealCookieBanner\Vendor\DevOwl\ServiceCloudConsumer\templates\AbstractTemplate {
    /**
    ...
    public function fromArray($arr) {
        ...
        if (\is_array($arr)) {
            ...
            $this->visualHeroButtonText = \is_string($arr['visualHeroButtonText'] ?? null)
                ? $arr['visualHeroButtonText']
                : '';
        }
    }
}
