 ...
 */
class TechnicalDefinitionsMiddleware extends
    ...
    public function beforeUsingTemplate($template) {
        if (
            ...
            \is_array($template->technicalDefinitions)
        ) {
            ...
            foreach ($template->technicalDefinitions as &$td) {
                ...
                if (
                    \in_array(
                        $host,
                        [
                            self::HOST_TYPE_CURRENT,
                            self::HOST_TYPE_CURRENT_PROTOCOL,
                            self::HOST_TYPE_CURRENT_WITH_ALL_SUBDOMAINS,
                            self::HOST_TYPE_MAIN,
                            self::HOST_TYPE_MAIN_WITH_ALL_SUBDOMAINS
                        ],
                        \true
                    )
                ) {
