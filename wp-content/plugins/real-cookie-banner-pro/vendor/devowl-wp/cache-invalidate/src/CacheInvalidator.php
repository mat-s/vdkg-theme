...
class CacheInvalidator {
    const CACHE_IMPLEMENTATIONS = [
        ...
        \DevOwl\RealCookieBanner\Vendor\DevOwl\CacheInvalidate\caches\AssetCleanupCacheImpl::IDENTIFIER =>
            \DevOwl\RealCookieBanner\Vendor\DevOwl\CacheInvalidate\caches\AssetCleanupCacheImpl::class,
        \DevOwl\RealCookieBanner\Vendor\DevOwl\CacheInvalidate\caches\PoweredCacheImpl::IDENTIFIER =>
            \DevOwl\RealCookieBanner\Vendor\DevOwl\CacheInvalidate\caches\PoweredCacheImpl::class
    ];
    /**
     * Singleton instance.
     *
