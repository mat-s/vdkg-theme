...
if (!\class_exists('DevOwl\\RealCookieBanner\\Vendor\\Puc_v4p11_Theme_UpdateChecker', \false)) {
    class Puc_v4p11_Theme_UpdateChecker extends \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_UpdateChecker
    {
        ...
        {
            return new \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Scheduler($this, $checkPeriod, array('load-themes.php'));
        }
        /**
        ...
        {
            return new \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_DebugBar_Extension($this, 'Puc_v4p11_DebugBar_ThemePanel');
        }
        /**
