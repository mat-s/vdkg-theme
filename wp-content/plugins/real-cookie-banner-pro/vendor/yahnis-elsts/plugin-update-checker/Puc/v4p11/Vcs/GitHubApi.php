...
if (!\class_exists('DevOwl\\RealCookieBanner\\Vendor\\Puc_v4p11_Vcs_GitHubApi', \false)) {
    class Puc_v4p11_Vcs_GitHubApi extends \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Vcs_Api
    {
        ...
        public function getLatestTag()
        {
            ...
            $tag = $versionTags[0];
            return new \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Vcs_Reference(array('name' => $tag->name, 'version' => \ltrim($tag->name, 'v'), 'downloadUrl' => $tag->zipball_url, 'apiResponse' => $tag));
        }
        /**
