...
if (!\class_exists('DevOwl\\RealCookieBanner\\Vendor\\Puc_v4p11_UpdateChecker', \false)) {
    abstract class Puc_v4p11_UpdateChecker
    {
         ...
         */
        protected function fixSupportedWordpressVersion(\DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Metadata $update = null)
        {
        ...
        {
            if (\class_exists('DevOwl\\RealCookieBanner\\Vendor\\Debug_Bar', \false) && \file_exists(\dirname(__FILE__) . '/DebugBar')) {
