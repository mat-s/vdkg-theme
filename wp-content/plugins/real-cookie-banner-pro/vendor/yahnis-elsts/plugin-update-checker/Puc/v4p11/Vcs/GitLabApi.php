...
if (!\class_exists('DevOwl\\RealCookieBanner\\Vendor\\Puc_v4p11_Vcs_GitLabApi', \false)) {
    class Puc_v4p11_Vcs_GitLabApi extends \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Vcs_Api
    {
        ...
        public function getLatestRelease()
        {
            ...
            $reference = new \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Vcs_Reference(array(
        ...
        public function getLatestTag()
        {
            ...
            $tag = $versionTags[0];
            return new \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Vcs_Reference(array('name' => $tag->name, 'version' => \ltrim($tag->name, 'v'), 'downloadUrl' => $this->buildArchiveDownloadUrl($tag->name), 'apiResponse' => $tag));
        }
        /**
        ...
        public function getBranch($branchName)
        {
            ...
            $reference = new \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Vcs_Reference(array('name' => $branch->name, 'downloadUrl' => $this->buildArchiveDownloadUrl($branch->name), 'apiResponse' => $branch));
