 ...
 */
class IssuuPreset extends \DevOwl\RealCookieBanner\presets\pro\blocker\IssuuPreset {
    ...
    public function common() {
        ...
        return \array_merge($parent, [
            'attributes' => \array_merge(
                [
                    'name' => $parent['name'],
                    'serviceTemplates' => [\DevOwl\RealCookieBanner\presets\pro\IssuuPreset::IDENTIFIER],
                    'isVisual' => \true,
                    'visualType' => 'default',
