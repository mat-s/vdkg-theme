...
class Utils {
    ...
    public static function isPageBuilder() {
        return isset($_GET['fl_builder']) ||
            ...
            (isset($_GET['et_fb']) || isset($_GET['et_pb_preview'])) ||
            ...
            (\class_exists(\MFN_Options::class) && isset($_GET['visual']) && $_GET['visual'] === 'iframe') ||
            isset($_GET['tve']) ||
            isset($_GET['ct_builder']) ||
            (\function_exists('Breakdance\\isRequestFromBuilderIframe') &&
                (\Breakdance\isRequestFromBuilderIframe() || \Breakdance\isRequestFromBuilderSsr())) ||
