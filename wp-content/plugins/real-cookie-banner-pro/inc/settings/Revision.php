        ...
        return apply_filters(
            ...
            \array_merge(
                ...
                [
                    ...
                    'contexts' => \DevOwl\RealCookieBanner\UserConsent::getInstance()->getPersistedContexts(),
        ...
        if ($implicit) {
            ...
            if ($cookieVersion > \DevOwl\RealCookieBanner\settings\Consent::COOKIE_VERSION_1) {
                ...
                if ($cookieVersion > \DevOwl\RealCookieBanner\settings\Consent::COOKIE_VERSION_2) {
                    ...
                    $cookieDomainAndPathIdentifier .=
                        ',' . \is_string($cookieDomain) &&
                        \DevOwl\RealCookieBanner\Utils::startsWith($cookieDomain, '.')
                            ? 'wildcard'
                            : 'no-wildcard';
                }
