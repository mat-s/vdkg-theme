 ...
 */
class BlockerStorage extends \DevOwl\RealCookieBanner\Vendor\DevOwl\ServiceCloudConsumer\storages\AbstractStorage {
    private $helper;
    /**
     * C'tor.
     *
    ...
    public function persist($templates) {
        $this->helper->persist($templates, function ($template) {
            ...
            $template = $template;
            return [
                'extendsIdentifier' => $template->extendsIdentifier,
                'ruleGroups' => $template->ruleGroups,
