...
/**
 * This storage persists and reads service templates from `wp_rcb_templates` database table.
 *
 ...
 */
class ServiceStorage extends \DevOwl\RealCookieBanner\Vendor\DevOwl\ServiceCloudConsumer\storages\AbstractStorage {
    private $helper;
    /**
     * C'tor.
     *
