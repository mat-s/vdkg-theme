...
class Core extends \DevOwl\RealCookieBanner\base\Core implements
    ...
    protected function __construct() {
        ...
        $presetsPluginIntegrations = \DevOwl\RealCookieBanner\comp\PresetsPluginIntegrations::getInstance();
        ...
        (new \DevOwl\RealCookieBanner\Vendor\MatthiasWeb\Utils\FixInvalidJsonInDb())->fixMetadataBySingleMetaKey(
        ...
        add_filter('RCB/Presets/Cookies/MiddlewareCallbacks', function ($callbacks) use (
            ...
            $callbacks[] = [new \DevOwl\RealCookieBanner\presets\middleware\CookiesSetUniqueName(), 'middleware'];
            return $callbacks;
        });
        ...
        add_action(
            ...
            [$presetsPluginIntegrations, 'presets_plugin_false_positives'],
            10,
            4
        );
        ...
        add_action('DevOwl/Utils/NewVersionInstallation/' . RCB_SLUG, [
            ...
            'new_version_installation_after_3_4_13'
        ]);
        add_action('DevOwl/Utils/NewVersionInstallation/' . RCB_SLUG, [
            \DevOwl\RealCookieBanner\settings\Cookie::getInstance(),
            'new_version_installation_after_3_4_13'
        ...
        add_action('DevOwl/Utils/NewVersionInstallation/' . RCB_SLUG, [
            \DevOwl\RealCookieBanner\UserConsent::getInstance(),
            'new_version_installation_after_3_4_13'
        ]);
        add_action('DevOwl/Utils/NewVersionInstallation/' . RCB_SLUG, [
            \DevOwl\RealCookieBanner\view\checklist\PrivacyPolicyMentionUsage::class,
            'new_version_installation_after_3_4_13'
        ]);
        ...
        add_action('DevOwl/RealProductManager/LicenseActivation/StatusChanged/' . RCB_SLUG, [
            \DevOwl\RealCookieBanner\templates\TemplateConsumers::getInstance(),
    ...
    public function init() {
        ...
        add_action('save_post_page', [\DevOwl\RealCookieBanner\settings\General::getInstance(), 'save_post_page']);
        add_action(
        ...
        add_action(
            'update_option_' . \DevOwl\RealCookieBanner\settings\General::SETTING_IMPRINT_ID,
            [\DevOwl\RealCookieBanner\settings\General::getInstance(), 'update_option_imprint'],
            10,
            2
        );
        ...
        add_filter(
            'RCB/Revision/BackwardsCompatibility',
            [\DevOwl\RealCookieBanner\settings\Cookie::getInstance(), 'applyMetaLegalNoticeUrlBackwardsCompatibility'],
            10,
            2
        );
        add_filter(
