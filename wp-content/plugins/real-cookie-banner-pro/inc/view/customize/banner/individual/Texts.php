    ...
    public function args() {
        ...
        return [
            ...
            'controls' => [
                ...
                self::SETTING_POSTAMBLE => [
                    'name' => 'postamble',
                    'label' => __('Additional teachings below service groups', RCB_TD),
                    'description' => __(
                        'If you need to place additional instructions in your country, such as an introduction to deleting cookies, they can be displayed. Typically only necessary if you are deliberately addressing other jurisdictions outside the EU.',
                        RCB_TD
                    ),
                    'class' => \DevOwl\RealCookieBanner\Vendor\DevOwl\Customize\controls\TinyMCE::class,
                    'type' => 'textarea',
                    'setting' => [
                        'default' => $defaultButtonTexts['postamble'],
                        'sanitize_callback' => 'wp_kses_post',
                        'allowEmpty' => \true
                    ]
                ]
