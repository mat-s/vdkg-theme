    ...
    public static function getDefaultButtonTexts() {
        ...
        $defaults = [
            ...
            'blockerLoadButton' => _x(
                'Accept services and load content',
                'legal-text',
                \DevOwl\RealCookieBanner\comp\language\Hooks::TD_FORCED
            ),
            'blockerAcceptInfo' => _x(
                'Loading the blocked content will adjust your privacy settings. Content from this service will not be blocked in the future.',
                'legal-text',
                \DevOwl\RealCookieBanner\comp\language\Hooks::TD_FORCED
            )
        ];
