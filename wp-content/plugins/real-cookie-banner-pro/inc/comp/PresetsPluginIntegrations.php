...
class PresetsPluginIntegrations {
    ...
    public function middleware_cookies_recommended(&$preset) {
        ...
        $preset['recommended'] = apply_filters(
            ...
            $this->presets_cookies_recommended($preset['recommended'] ?? \false, $preset['id']),
            $preset
        );
        return $preset;
    }
    ...
    public function middleware_blocker_recommended(&$preset) {
        ...
        $preset['recommended'] = apply_filters(
            ...
            $this->presets_blocker_recommended($preset['recommended'] ?? \false, $preset['id']),
            $preset
        );
        return $preset;
    }
     ...
     */
    public function presets_cookies_recommended($recommended, $identifier) {
        switch ($identifier) {
     ...
     * @param string $identifier
     */
    public function presets_blocker_recommended($recommended, $identifier) {
        switch ($identifier) {
            default:
                break;
        }
     ...
     * @param string $type
     */
    public function presets_plugin_false_positives($isActive, $plugin, $identifier, $type) {
        switch ($plugin) {
    ...
    public static function getInstance() {
        return self::$me === null
            ? (self::$me = new \DevOwl\RealCookieBanner\comp\PresetsPluginIntegrations())
            : self::$me;
    }
}
